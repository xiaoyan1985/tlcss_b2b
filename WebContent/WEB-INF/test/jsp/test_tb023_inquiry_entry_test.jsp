...
<tiles:insertDefinition name="default.layout">
	<tiles:putAttribute name="script">
		...
		$(function() {
			...
			$('#btnToInquiryEntry').click(function(e) {
				...
				$('#main_inquiry_entry').prop('action', '<s:url action="inquiryEntryInit" />');
			...
			$('#btnToInquiryUpdate').click(function(e) {
				...
				$('#main_inquiry_entry').prop('action', '<s:url action="inquiryEntryUpdateInit" />');
				$('#main_inquiry_entry').prop('target', '_self');
	...
	<tiles:putAttribute name="title">問い合わせ登録テスト</tiles:putAttribute>
	<tiles:putAttribute name="body">
		...
		<s:form id="main_inquiry_entry" method="POST" enctype="multipart/form-data">
			<div id="content">
				<table>
					...
					<tr>
						...
						<td>「NULL：新規登録時、NOT NULL：更新時」「yyyy/mm/dd hh:mm:ss」</td>
					</tr>
					--%>
					<tr>
			...
			<input type="button" id="btnToInquiryEntry" class="btnSubmit" value="問い合わせ登録(新規)" />
			<input type="button" id="btnToInquiryUpdate" class="btnSubmit" value="問い合わせ登録(更新)" />
		</s:form>
